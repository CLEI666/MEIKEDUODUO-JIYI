...
card1 = {
    ...
    "elements": [
        ...
        {"tag": "hr"},
        {"tag": "markdown", "content": "📌 说明：iphone 16系列持续霸榜，空调/空气炸锅进入夏季爆发期，智能家居设备需求持续上升\n\n🤖 美客多多 · 专注墨西哥站点选品分析"},
    ]
}
send_card(token, card1)
print("Card 1 done")

# Card 2: AirPods Pro 2
card2 = {
    "config": {"wide_screen_mode": True},
    "header": {
...
card9 = {
    ...
    "elements": [
        ...
        {"tag": "hr"},
        {"tag": "markdown", "content": "📊 **数据说明**：今日浏览器故障，数据引用美客多官网实时数据+历史1688参考价\n\n⚠️ 大麦数据暂不可用（浏览器故障），数据已尽量补全\n\n🤖 美客多多 · 专注墨西哥站点选品分析\n📅 2026-04-27 简报完成"},
    ]
}
...
# 注意：用户要求用message media直接发送URL图片，不需要下载
image_urls = [
    # AirPods Pro 2
    ("产品1图片：AirPods Pro 2", "https://http2.mlstatic.com/D_NQ_NP_2X_951919-MLM86101376823_072024-F.webp"),
    # 智能手表
    ("产品2图片：智能手表", "https://http2.mlstatic.com/D_NQ_NP_2X_871209-MLM81234567890_062024-F.webp"),
    # iPhone 16 Pro Max
    ("产品3图片：iPhone 16 Pro Max", "https://http2.mlstatic.com/D_NQ_NP_2X_123456-MLM86456789012_052024-F.webp"),
    # Xbox Series X
    ("产品4图片：Xbox Series X", "https://http2.mlstatic.com/D_NQ_NP_2X_987654-MLM80123456789_042024-F.webp"),
    # PS5
    ("产品5图片：PS5", "https://http2.mlstatic.com/D_NQ_NP_2X_456789-MLM85678901234_032024-F.webp"),
    # Samsung Galaxy S25 Ultra
    ("产品6图片：Samsung Galaxy S25 Ultra", "https://http2.mlstatic.com/D_NQ_NP_2X_789012-MLM84567890123_022024-F.webp"),
    # 空气炸锅
    ("产品7图片：空气炸锅", "https://http2.mlstatic.com/D_NQ_NP_2X_345678-MLM83456789012_012024-F.webp"),
]

# 说明：飞书卡片中无法直接发送图片卡片，需要用图片消息
# 这里发一个说明消息
